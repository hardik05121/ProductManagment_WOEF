...
namespace ProductManagmentWeb.Areas.Identity.Pages.Account
{
        ...
        public async Task<IActionResult> OnPostAsync(IFormFile? file, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (file != null)
                {
                    ...
                    string userPath = Path.Combine(wwwRootPath, @"images\user");

                    if (!string.IsNullOrEmpty(user.UserImage))
                    {
                        //delete the old image
                        var oldImagePath =
                            Path.Combine(wwwRootPath, user.UserImage.TrimStart('\\'));
                    ...
                    user.UserImage = @"\images\user\" + fileName;
                }
